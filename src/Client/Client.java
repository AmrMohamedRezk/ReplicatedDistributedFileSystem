...
public class Client implements MasterServerClientInterface,ReplicaServerClientInterface {

	/*
	 * STATUS:
	 * 1) Clients read and write data to the distributed file system.
	 * STATUS:DONE
	 * 2) Each client has a file in its local directory that specifies 
	 * the main server IP address.
	 * STATUS: 
	 * 3)The server should communicate with clients through the given RMI interface.
	 * 
	 */
